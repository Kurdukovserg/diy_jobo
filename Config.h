...
// ---------- PIN DEFINITIONS ----------
  ...
  constexpr uint8_t PIN_BTN_OK   = D6;   // OK button (start/stop)
  constexpr uint8_t PIN_BTN_BACK = D0;   // BACK button (stop/menu)
...
// ---------- TIMING ----------
constexpr uint32_t ENC_DEBOUNCE_US = 150;  // reduced for better responsiveness
